...
OneNote Add-ins run across multiple versions of Office including Office Online and Office 365 ProPlus. The following table lists the OneNote requirement sets, the Office host applications that support that requirement set, and the build versions.
