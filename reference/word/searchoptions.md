...
|matchSoundsLike|bool|**This option was deprecated as of June update**. Gets or sets a value that indicates whether to find words that sound similar to the search string. Corresponds to the Sounds like check box in the Find and Replace dialog box|
