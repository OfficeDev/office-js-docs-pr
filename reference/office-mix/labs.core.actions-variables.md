...
The following table lists the variable declarations, with descriptions, for the [LabsJS.Labs.Core.Actions](https://dev.office.com/reference/add-ins/office-mix/labsjs.labs.core.actions) module of the Labs.js API.
