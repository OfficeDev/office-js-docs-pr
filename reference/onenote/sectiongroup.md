...
|[getRestApiId()](#getrestapiid)|string|Get the OneNote REST API ID of the section group.|[Go](https://github.com/OfficeDev/office-js-docs/issues/new?title=OneNote-sectionGroup-getRestApiId)|
