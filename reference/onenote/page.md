...
|[getRestApiId()](#getrestapiid)|string|Get the OneNote REST API ID of the page.|[Go](https://github.com/OfficeDev/office-js-docs/issues/new?title=OneNote-page-getRestApiId)|
