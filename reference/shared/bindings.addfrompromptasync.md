...
Adds a binding object of the specified type to the [Bindings](https://dev.office.com/reference/add-ins/shared/bindings.bindings) collection, which will be identified with the supplied _id_. The method fails if the specified selection cannot be bound.
