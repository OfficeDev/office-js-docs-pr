...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](https://dev.office.com/reference/add-ins/shared/asyncresult.value)|Always returns  **undefined** because there is no data or object to retrieve when setting formats.|
...
- To update table options, such as banded rows and filter buttons, use the [TableBinding.setTableOptions](https://dev.office.com/reference/add-ins/shared/binding.tablebinding.settableoptionsasync) method.
    
- To clear formatting, use the [TableBinding.clearFormats](https://dev.office.com/reference/add-ins/shared/binding.tablebinding.clearformatsasync) method.
