...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](https://dev.office.com/reference/add-ins/shared/asyncresult.value)|Access the [Binding](https://dev.office.com/reference/add-ins/shared/binding) object that represents the specified named item.|
...
The following example adds a binding to the  `myRange` named item in Excel as a "matrix" binding, and assigns the binding's [id](https://dev.office.com/reference/add-ins/shared/binding.id) as `myMatrix`.
