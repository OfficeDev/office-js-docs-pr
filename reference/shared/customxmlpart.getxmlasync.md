...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](https://dev.office.com/reference/add-ins/shared/asyncresult.value)|Access to a  **string** that contains the XML of the referenced [CustomXmlPart](https://dev.office.com/reference/add-ins/shared/customxmlnode.getnodesasync) object.|
