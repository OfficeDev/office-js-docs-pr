...
For the  **getTaskByIndexAsync** method, the returned [AsyncResult](https://dev.office.com/reference/add-ins/shared/asyncresult) object contains following properties.
...
|[value](https://dev.office.com/reference/add-ins/shared/asyncresult.value)|The GUID of the task as a  **string**.|

## Remarks

To get the maximum index of the collection of tasks for the project, use the [getMaxTaskIndexAsync](https://dev.office.com/reference/add-ins/shared/projectdocument.getmaxtaskindexasync) method. The 0 index task represents the project summary task.


## Example

The following code example calls [getMaxTaskIndexAsync](https://dev.office.com/reference/add-ins/shared/projectdocument.getmaxtaskindexasync) to get the maximum index in the project's task collection, and then calls **getTaskByIndexAsync** to get the GUID for each task.
...
[getMaxTaskIndexAsync](https://dev.office.com/reference/add-ins/shared/projectdocument.getmaxtaskindexasync)
