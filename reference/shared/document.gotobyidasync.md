...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](https://dev.office.com/reference/add-ins/shared/asyncresult.value)|Return the current view.|
...
-  **Create a table binding** using the [addFromSelectionAsync](https://dev.office.com/reference/add-ins/shared/bindings.addfromselectionasync) method as a sample binding to work with.
...
-  **Get the id** of the currently selected slides using the [getSelectedDataAsync](https://dev.office.com/reference/add-ins/shared/document.getselecteddataasync) method.
