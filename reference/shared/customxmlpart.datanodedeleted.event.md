...
To add an event handler for the  **dataNodeDeleted** event, use the [addHandlerAsync](https://dev.office.com/reference/add-ins/shared/customxmlpart.addhandlerasync) method of the **CustomXmlPart** object.
