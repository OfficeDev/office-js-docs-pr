...
|:-----|:-----|:-----|:-----|
| _bindingType_|[BindingType](https://dev.office.com/reference/add-ins/shared/bindingtype-enumeration)|Specifies the type of the binding object to create. Required. Returns  **null** if the selected object cannot be coerced into the specified type.||
| _options_|**object**|Specifies any of the following [optional parameters](../../docs/develop/asynchronous-programming-in-office-add-ins.md#passing-optional-parameters-to-asynchronous-methods).||
| _id_|**string**|Specifies the unique name to be used to identify the new binding object.If no argument is passed for the  _id_ parameter, the [Binding.id](https://dev.office.com/reference/add-ins/shared/binding.id) is autogenerated.||
...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](https://dev.office.com/reference/add-ins/shared/asyncresult.value)|Access the [Binding](https://dev.office.com/reference/add-ins/shared/binding) object that represents the selection specified by the user.|
...
Adds the specified type of binding object to the  **Bindings** collection, which will be identified with the supplied _id_.
 ...
 >**Note**  In Excel, if you call the  **addFromSelectionAsync** method passing in the **Binding.id** of an existing binding, the [Binding.type](https://dev.office.com/reference/add-ins/shared/binding.type) of that binding is used, and its type cannot be changed by specifying a different value for the _bindingType_ parameter.If you need to use an existing  _id_ and change the _bindingType_, call the [Bindings.releaseByIdAsync](https://dev.office.com/reference/add-ins/shared/bindings.releasebyidasync) method first to release the binding, and then call the **addFromSelectionAsync** method to reestablish the binding with a new type.


## Example

Adds a [TextBinding](https://dev.office.com/reference/add-ins/shared/binding.textbinding) to the current selection with a **Binding.id** of 'MyBinding'.
