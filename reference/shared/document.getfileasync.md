...
|:-----|:-----|:-----|:-----|
| _fileType_|[FileType](../../reference/shared/filetype-enumeration.md)|Specifies the format in which the file will be returned. Required.<br/><table><tr><th>Host</th><th>Supported fileType</th></tr><tr><td>Excel Online</td><td>Office.FileType.Compressed</td></tr><tr><td>PowerPoint on Windows desktop, Mac, and iPad and PowerPoint Online</td><td>Office.FileType.Compressed, Office.FileType.Pdf</td></tr><tr><td>Word on Windows desktop, Mac and iPad and Word Online</td><td>Office.FileType.Compressed, Office.FileType.Pdf, Office.FileType.Text</td></tr></table>|**Changed in** 1.1, see [Support history](#support-history)|
