...
|:-----|:-----|:-----|:-----|
| _fileType_|[FileType](https://dev.office.com/reference/add-ins/shared/filetype-enumeration)|Specifies the format in which the file will be returned. Required. See [fileType Value](#filetype-value). <br/>|**Changed in** 1.1, see [Support history](#support-history)|
...
|**Property**|**Use to...**|
|:-----|:-----|
|[AsyncResult.value](https://dev.office.com/reference/add-ins/shared/asyncresult.value)|Access the [File](https://dev.office.com/reference/add-ins/shared/file) object.|
...
No more than two documents are allowed to be in memory; otherwise the  **getFileAsync** operation will fail. Use the [File.closeAsync](https://dev.office.com/reference/add-ins/shared/file.closeasync) method to close the file when you are finished working with it.
