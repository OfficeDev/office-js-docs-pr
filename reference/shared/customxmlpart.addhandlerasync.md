...
| _handler_|**object**|The event handler function to add, whose only parameter is of type [NodeDeletedEventArgs](https://dev.office.com/reference/add-ins/shared/customxmlpart.nodedeletedeventargs), [NodeInsertedEventArgs](https://dev.office.com/reference/add-ins/shared/customxmlpart.nodeinsertedeventargs), or [NodeReplaceEventArgs](https://dev.office.com/reference/add-ins/shared/customxmlpart.nodereplacedeventargs). Required.||
