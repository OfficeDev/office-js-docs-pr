...
For the  **getResourceByIndexAsync** method, the returned [AsyncResult](https://dev.office.com/reference/add-ins/shared/asyncresult) object contains following properties.
...
|[value](https://dev.office.com/reference/add-ins/shared/asyncresult.value)|The GUID of the resource as a  **string**.|

## Remarks

To get the maximum index of the collection of resources for the project, use the [getMaxResourceIndexAsync](https://dev.office.com/reference/add-ins/shared/projectdocument.getmaxresourceindexasync) method. A resource collection does not contain a resource at the 0 index.


## Example

The following code example calls [getMaxResourceIndexAsync](https://dev.office.com/reference/add-ins/shared/projectdocument.getmaxresourceindexasync) to get the maximum index in the project's resource collection, and then calls **getResourceByIndexAsync** to get the GUID for each resource.
...
[getMaxResourceIndexAsync](https://dev.office.com/reference/add-ins/shared/projectdocument.getmaxresourceindexasync)
