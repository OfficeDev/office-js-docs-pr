...
|:-----|:-----|:-----|:-----|
|ExcelApi|1.2|Excel 2016<br>Excel&nbsp;Online<br>Excel for iPad<br>|Worksheet Protection<br>Worksheet Functions<br>Sort<br>Filter<br>R1C1 Reference Style<br>Range.merge()<br>Range.format.autofitRows()<br>chart.getImage()|
