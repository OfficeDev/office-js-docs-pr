...
|CompressedFile|1.1|PowerPoint<br/>Word<br/>Word&nbsp;Online<br/>Word&nbsp;iOS<br/>Word&nbsp;MAC<br/>Excel&nbsp;Online<br/>PowerPoint&nbsp;Online|Supports output to Office Open XML (OOXML) format as a byte array<br>(Office.FileType.Compressed) when using the Document.getFileAsync method.|
...
|PdfFile|1.1|PowerPoint<br/>Word<br/>Word&nbsp;Online<br/>Word&nbsp;iOS<br/>Word&nbsp;MAC<br/>PowerPoint&nbsp;Online|Supports output to PDF format (Office.FileType.Pdf)<br>when using the Document.getFileAsync method.|
...
|TextFile|1.1|Word<br/>Word&nbsp;Online <br/>Word&nbsp;iOS<br/>Word&nbsp;MAC<br/>|Supports output to text format (Office.FileType.Text) when using the Document.getFileAsync method.|
