...
IF NOT DEFINED DEPLOYMENT_TEMPLATE (
  SET DEPLOYMENT_TEMPLATE=%SITE%\wwwroot\MDConvert\html-template
)

IF NOT DEFINED APIDOCS_PATH (
  SET APIDOCS_PATH=%SITE%\wwwroot\MDConvert\bin
)
...
Copy-Item %DEPLOYMENT_SOURCE%\images %DEPLOYMENT_TARGET_DIR%\images -recurse
