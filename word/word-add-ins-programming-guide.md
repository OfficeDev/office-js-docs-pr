...
**This documentation has been moved to a new [location](../docs/word/word-add-ins-programming-guide.md). This content is now published to [dev.office.com](http://dev.office.com/docs/add-ins/word/word-add-ins-programming-overview?product=word).**
