...
**This documentation has been moved to a new [location](../docs/word/word-add-ins.md). This content is now published to [dev.office.com](http://dev.office.com/docs/add-ins/word/word-add-ins?product=word).**
