...
4. Open the file **index.js** in the root of the project to specify the script for the add-in. Replace the entire contents with the following code and save the file.
