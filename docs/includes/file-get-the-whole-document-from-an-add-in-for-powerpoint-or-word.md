...
You can also create an add-in for PowerPoint or Word by using [Visual Studio](../tutorials/create-and-debug-office-add-ins-in-visual-studio.md) or [any editor](../tutorials/create-an-office-add-in-using-any-editor.md). 
