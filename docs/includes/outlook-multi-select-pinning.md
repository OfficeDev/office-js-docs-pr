...
- **Windows (new and classic) and web**: The task pane doesn't stay open when the user switches to a new item. To keep the task pane open, select the **pin** icon on the task pane.
