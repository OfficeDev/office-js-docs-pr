...
4. Using File Explorer, navigate to the downloaded folder on your computer and extract the contents of the folder.

5. Navigate to the location that contains the content extracted in the previous step, and copy the `src\app\templates\js\base\certs` folder to your clipboard.
