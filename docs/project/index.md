            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="../reference/overview/project-add-ins-reference-overview.md">Learn how to use the Office JavaScript API to access tasks, resources, and views in a project.</a></p>
                    </div>
                </div>
            </div>
        </div>
