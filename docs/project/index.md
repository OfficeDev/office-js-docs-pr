        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Overview</h3>
                        <p><a href="project-add-ins.md">Learn about the components and capabilities of a Project add-in.</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="../quickstarts/project-quickstart.md">Build your first Project add-in in under 5 minutes</a>.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="../testing/test-debug-office-add-ins.md">Learn how to test and debug a Project add-in.</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Publishing</h3>
                        <p><a href="../publish/publish.md">Learn how to deploy and publish a Project add-in.</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<p>All Office Add-ins are built upon the Office Add-ins platform, and therefore share a common framework through which certain capabilities can be implemented. The following articles contain information that's relevant to any type of Office Add-in, including Project add-ins.</p>
