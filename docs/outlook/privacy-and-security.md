...
> [!NOTE]
> Activation rules, as seen in this example, aren't supported in add-ins that use the [Unified manifest for Microsoft 365 (preview)](../develop/json-manifest-overview.md).
