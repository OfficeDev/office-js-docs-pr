...
|-----|-----|
|- Windows<sup>1</sup><br>- Mac|The **All Apps**<sup>2</sup> or **Get Add-ins** button isn't displayed, so users aren't able to manage their add-ins or access AppSource.|
