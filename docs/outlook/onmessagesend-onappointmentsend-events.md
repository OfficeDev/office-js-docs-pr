...
|**Supported Outlook clients**|<ul><li>Windows (new and classic)</li><li>Web browser (modern UI)</li><li>Mac (new UI)</li></ul>|<ul><li>Windows (classic and new)</li><li>Web browser (modern and classic UI)</li><li>Mac (new and classic UI)</li></ul>|
