...
|API member|Time zone representation|Example in Outlook on the web, on mobile devices, and in new Windows client|Example in Outlook on Windows (classic) and on Mac|
|--------------|----------------------------|-------------------------------------|-------------------|
