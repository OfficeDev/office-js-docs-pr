...
1. Add-ins that log appointment details and related notes to CRM or note-taking services can be activated in Appointment Attendee mode. For more about this exception (including available APIs), refer to [Log appointments to a CRM application in Outlook mobile add-ins](mobile-log-crm.md#available-apis).
