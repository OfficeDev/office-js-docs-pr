...
There are two possible formats for the manifest: XML and JSON. You can learn about the JSON manifest at [Unified manifest for Microsoft 365 (preview)](../develop/json-manifest-overview.md). This article is about the XML manifest.
