...
- The HTML body of an item is slightly different between Outlook on Windows or on Mac, and Outlook on the web or on mobile devices. Define your regular expressions carefully.
