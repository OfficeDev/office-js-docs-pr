...
Outlook add-ins are now supported on the new Mac UI (preview), up to requirement set 1.9. However, the following requirement sets and features are **NOT** supported yet.
