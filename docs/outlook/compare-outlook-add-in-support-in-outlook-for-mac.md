...
| Version string of the host | The format of the version string returned by [diagnostics.hostVersion](../reference/objectmodel/preview-requirement-set/office.context.mailbox.diagnostics.md#properties) depends on the actual type of host. For example:<ul><li>Outlook on Windows: `15.0.4454.1002`</li><li>Outlook on the web: `15.0.918.2`</li></ul> |An example of the version string returned by `Diagnostics.hostVersion` on Outlook on Mac: `15.0 (140325)` |
