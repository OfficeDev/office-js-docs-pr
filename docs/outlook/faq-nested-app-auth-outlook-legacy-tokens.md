...
| Jun 2025 | Legacy tokens turned off for all tenants. Admins can no longer reenable legacy tokens via PowerShell. Admins can request an exception through Microsoft support at [http://aka.ms/LegacyTokensByOctober](http://aka.ms/LegacyTokensByOctober) (this link requires you to sign in to your tenant). |
