...
description: Guidelines to help you design and build a compelling add-in, which brings the best of your app right into Outlook on the web, Windows, Mac, iOS, and Android.
ms.date: 08/12/2021
...
The following high-level guidelines will help you design and build a compelling add-in, which brings the best of your app right into Outlook&mdash;on the web, Windows, Mac, iOS, and Android.
