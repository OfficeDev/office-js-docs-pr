...
- An event-based add-in that runs in Outlook on Windows only supports a single JavaScript file in the add-in project. You must bundle your JavaScript code into a single file.
