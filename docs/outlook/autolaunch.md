...
In new Outlook on Windows, you must keep the main window of the client open for the add-in to process the mail item. If the main window of the Outlook client is minimized, the add-in will pause or stop working.
