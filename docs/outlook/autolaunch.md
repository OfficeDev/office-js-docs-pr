...
- For Outlook on Windows: The minimum required build is 16.0.13729.20000. You may need to join the [Office Insider program](https://insider.office.com) for access to more recent Office builds.
