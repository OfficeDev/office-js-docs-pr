...
- For Outlook on Windows: The minimum required build is 16.0.14026.10000. Join the [Office Insider program](https://insider.office.com) for access to Office beta builds.
