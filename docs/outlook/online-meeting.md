...
- The type of manifest; either XML or [Unified manifest for Microsoft 365 (preview)](../develop/json-manifest-overview.md).
...
> [!IMPORTANT]
> Online meeting providers aren't yet supported for the [Unified manifest for Microsoft 365 (preview)](../develop/json-manifest-overview.md). This tab is for future use.
