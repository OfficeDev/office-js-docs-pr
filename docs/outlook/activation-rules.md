...
|[ItemHasRegularExpressionMatch](#itemhasregularexpressionmatch-rule)|Read|Checks to see whether the sender's email address, the subject, or the body of the selected item contains a match to a regular expression.|
...
For more information about using the `ItemHasRegularExpressionMatch` rule, see [Contextual Outlook add-ins](contextual-outlook-add-ins.md).
...
To provide a satisfactory experience with Outlook add-ins, you should adhere to the activation and API usage guidelines. To learn about these guidelines, see [Limits for activation and JavaScript API for Outlook add-ins](limits-for-activation-and-javascript-api-for-outlook-add-ins.md#limits-of-activation-rules-for-contextual-outlook-add-ins) and [Troubleshoot Outlook add-in activation](troubleshoot-outlook-add-in-activation.md).
