...
|Mail item transformation|Enable users to transform mail items into other formats.|Supported.|<ul><li>[Drag and drop messages and attachments into the task pane of an Outlook add-in](drag-drop-items.md)</li><li>[getAsFileAsync method](/javascript/api/outlook/office.messageread#outlook-office-messageread-getasfileasync-member(1))</li></ul>|
