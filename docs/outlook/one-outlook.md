...
|Attachment management|Enable users to import or export attachments from partner locations.|Supported.|<ul><li>[Activate your Outlook add-in on multiple messages](item-multi-select.md)</li><li>[Activate your Outlook add-in without the Reading Pane enabled or a message selected](contextless.md)</li><li>[Activate add-ins with events](../develop/event-based-activation.md)</li><li>[Check an attachment before it's opened, saved, or downloaded (preview)](on-attachment-action-event.md)</li><li>[Drag and drop messages and attachments into the task pane of an Outlook add-in](drag-drop-items.md)</li></ul>|
