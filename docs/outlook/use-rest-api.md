...
Your add-in can determine which Outlook client it is loaded in by checking the [Office.context.mailbox.diagnostics.hostName](../reference/objectmodel/preview-requirement-set/office.context.mailbox.diagnostics.md#properties) property.
