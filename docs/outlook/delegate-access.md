...
| Scenario | Applicable Outlook clients<ul><li>Web (same tab or window)</li><li>Windows (new: non-promoted mailbox)</li><li>Windows (classic)</li><li>Mac</li></ul> | Applicable Outlook clients<ul><li>Web (separate tab or window)</li><li>Windows (new: promoted mailbox)</li></ul> |
| ----- | ----- | ----- |
