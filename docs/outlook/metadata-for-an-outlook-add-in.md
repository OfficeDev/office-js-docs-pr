...
Custom data is saved to the SessionData object as key-value pairs. For each mail item, add-ins that support Mailbox requirement set 1.15 or earlier can store up to 50,000 characters per add-in. Add-ins that support Mailbox requirement set 1.16 or later can store up to 2,621,440 characters per add-in.
