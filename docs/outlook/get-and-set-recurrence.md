...
> [!NOTE]
> Support for this feature was introduced in requirement set 1.7. See [clients and platforms](/javascript/api/requirement-sets/outlook-api-requirement-sets#requirement-sets-supported-by-exchange-servers-and-outlook-clients) that support this requirement set.
