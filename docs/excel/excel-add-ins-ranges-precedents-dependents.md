...
A cell may have a precedent cell, and that precedent cell may have its own precedent cells. A "direct precedent" is the first group of cells in this line of precession, similar to the concept of parents in a parent-child relationship. A "direct dependent" is the first group of cells in a line of succession, similar to children in a parent-child relationship. Cells that refer to other cells in a workbook, but whose relationship is not a parent-child relationship are not direct dependents or direct precedents.
