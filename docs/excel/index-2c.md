        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Overview</h3>
                        <p><a href="excel-add-ins-overview.md">Learn about the components and capabilities of an Excel add-in.</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="excel-add-ins-get-started-overview.md">Build your first Excel add-in by completing a 5-minute quick start</a> and <a href="../overview/explore-with-script-lab.md">explore the API with Script Lab</a>.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="custom-functions-overview.md">Learn how to add custom functions to Excel by defining those functions in JavaScript as part of an add-in.</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="../testing/test-debug-office-add-ins.md">Learn how to test and debug Excel add-ins.</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Publishing</h3>
                        <p><a href="../publish/publish.md">Learn how to deploy and publish Excel add-ins.</a></p>
                    </div>
                </div>
            </div>
        </div>
