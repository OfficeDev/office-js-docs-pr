...
Finally, the reference method needs the custom function to call to implement. Previously the custom function was called as `Contoso.Get27()` in the body property of the reference method. The following code shows how to implement the custom function.
...
You can use optional arguments in reference methods.
