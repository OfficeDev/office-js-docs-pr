...
>[!IMPORTANT]
> Auto-generated metadata doesn't work for localization so you need to update the JSON file manually. To learn how to do this, see [Metadata for custom functions in Excel](custom-functions-json.md)
