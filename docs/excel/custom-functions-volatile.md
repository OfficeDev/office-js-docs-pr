...
To mark a custom function as volatile, add the `@volatile` tag to its JSDoc comment. For more information about custom functions JSON metadata, see [Autogenerate JSON metadata for custom functions](custom-functions-json-autogeneration.md).
