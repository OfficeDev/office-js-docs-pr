...
| `onSingleClicked` | Occurs when left-clicked/tapped operation happens in the worksheet. | [**Worksheet**](/javascript/api/excel/excel.worksheet), [**WorksheetCollection**](/javascript/api/excel/excel.worksheetcollection) |
