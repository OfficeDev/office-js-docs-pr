...
| `onLinkedEntityCellValueLoaded` | Occurs when the request to load a [LinkedEntityCellValue](/javascript/api/excel/excel.linkedentitycellvalue) object is completed. To learn more, see [Create linked entity data types in Excel add-ins](excel-data-types-linked-entity-cell-values.md). | [**LinkedEntityDataDomainCollection**](/javascript/api/excel/excel.linkedentitydatadomaincollection#excel-excel-linkedentitydatadomaincollection-onlinkedentitycellvalueloaded-member) |
| `onLinkedEntityDataDomainAdded` | Occurs when a new linked entity data domain is added to the workbook. To learn more, see [Create linked entity data types in Excel add-ins](excel-data-types-linked-entity-cell-values.md). | [**LinkedEntityDataDomainCollection**](/javascript/api/excel/excel.linkedentitydatadomaincollection#excel-excel-linkedentitydatadomaincollection-onlinkedentitydatadomainadded-member) |
...
| `onRefreshCompleted` | Occurs when the request to refresh [LinkedEntityCellValue](/javascript/api/excel/excel.linkedentitycellvalue) objects of a linked entity data domain is completed. To learn more, see [Create linked entity data types in Excel add-ins](excel-data-types-linked-entity-cell-values.md). | [**LinkedEntityDataDomainCollection**](/javascript/api/excel/excel.linkedentitydatadomaincollection#excel-excel-linkedentitydatadomaincollection-onrefreshcompleted-member) |
| `onRefreshModeChanged` | Occurs when the [refreshMode](/javascript/api/excel/excel.linkedentitydatadomain#excel-excel-linkedentitydatadomain-refreshmode-member) property of a linked entity data domain is changed. To learn more, see [Create linked entity data types in Excel add-ins](excel-data-types-linked-entity-cell-values.md). | [**LinkedEntityDataDomainCollection**](/javascript/api/excel/excel.linkedentitydatadomaincollection#excel-excel-linkedentitydatadomaincollection-onrefreshmodechanged-member) |
