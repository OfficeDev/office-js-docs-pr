...
> [!NOTE]
> COM add-in and XLL user-defined function (UDF) compatibility is supported by the following platforms, when connected to a Microsoft 365 subscription.
>
> - Excel on the web
