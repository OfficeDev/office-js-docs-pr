...
2.  Create an Excel-Custom-Functions using Yo Office (https://github.com/OfficeDev/generator-office), and follow the instructions in the project README.md to start the add-in in Excel, make changes in the code, and debug.
