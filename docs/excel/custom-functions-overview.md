...
> [!NOTE]
> Detailed reference for the registraion JSON of custom functions, including options not used in this example is at [Custom Functions JSON](custom-functions-json).
