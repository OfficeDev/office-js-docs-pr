...
- In the 32-bit version of the Office 365 December Insiders version 1901 (Build 11128.20000), custom functions may not work properly. As a work around for this bug, please copy the contents of [this file on Github](https://github.com/OfficeDev/Excel-Custom-Functions/blob/december-insiders-workaround/excel-udf-host.win32.bundle). Using your favorite code editor, paste your copied code into a new file, named excel-udf-host.win32.bundle. Save this file into your "C:\Program Files (x86)\Microsoft Office\root\Office16" folder.
