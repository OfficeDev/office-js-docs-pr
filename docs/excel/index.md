            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="../quickstarts/excel-quickstart-jquery.md">Build your first Excel add-in in under 5 minutes</a>, then <a href="../overview/explore-with-script-lab.md">explore the API with Script Lab</a>.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="../testing/test-debug-office-add-ins.md">Learn how to test and debug an Excel add-in.</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Publishing</h3>
                        <p><a href="../publish/publish.md">Learn how to deploy and publish an Excel add-in.</a></p>
                    </div>
                </div>
            </div>
        </div>
