...
description: 'Data types in the Excel JavaScript API enable Office Add-in developers to work with formatted number values, web images, entity values, and enhanced errors as data types.'
ms.date: 10/27/2021
ms.topic: conceptual
ms.prod: excel
