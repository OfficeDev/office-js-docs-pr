...
To declare a function as streaming using autogenerated JSON metadata, use the tag `@stream` in your function's script file.
...
To declare a function as cancelable using autogenerated JSON metadata, use the tag `@cancelable` in your function's script file.
