...
- **Visual Studio Code**: Choose this environment if you use Visual Studio Code and would prefer to create projects from an extension rather than command line tools. The project creation and scaffolding tools is Microsoft 365 Agents Toolkit.
