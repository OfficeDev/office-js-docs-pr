...
## Agenda for August 14, 2024 call
Here is the agenda for the August Office Add-ins community call.
* Visual Studio Code extension for Office Add-ins update.
* Install add-ins through deep linking.
* Establishing equivalent web add-ins when switching to New Outlook for Windows.
* Custom Functions update.
