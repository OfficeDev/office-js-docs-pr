...
> [!TIP]
> For any type of add-in that you build, you'll use information in the [Office Add-ins guidance](general-guidance.md) section of this documentation, along with information in the host-specific section that corresponds to the type of add-in you're building (for example, [Excel add-ins](../excel/index.md)).
>
