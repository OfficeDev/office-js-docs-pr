...
> [!NOTE]
> The initial Office 2016 release installed via MSI (i.e., one-time purchase) only contains the ExcelApi 1.1, WordApi 1.1, and Common API requirement sets. For more information about the update history of the various Office versions, check out the [See also](#see-also) section.
