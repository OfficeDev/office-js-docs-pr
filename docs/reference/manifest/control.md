...
In the following example, the button is disabled when the add-in launches. It can be programmatically enabled. For more information, see [Enable and Disable Add-in Commands](/add-ins/design/disable-add-in-commands).
