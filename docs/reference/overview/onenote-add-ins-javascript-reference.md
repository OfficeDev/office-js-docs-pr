...
A OneNote add-in interacts with objects in OneNote on the web by using the [Office JavaScript API Library](../../develop/understand-the-javascript-api-for-office.md), which includes two JavaScript object models:
