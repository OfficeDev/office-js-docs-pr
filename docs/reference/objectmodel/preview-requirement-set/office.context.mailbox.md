...
You do not need to set the encoding value when your mail app is running in Outlook. You can determine whether your mail app is running in Outlook by using the mailbox.diagnostics.hostName property. You can determine what version of Outlook is running by using the mailbox.diagnostics.hostVersion property.
