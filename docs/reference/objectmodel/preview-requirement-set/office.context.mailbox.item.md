...
| displayReplyAllFormAsync(formData, [options], [callback]) | ReadItem | [Appointment Attendee](/javascript/api/outlook/office.appointmentread?view=outlook-js-preview#displayreplyallform-formdata-options--callback-) | [Preview](outlook-requirement-set-preview.md) |
| | | [Message Read](/javascript/api/outlook/office.messageread?view=outlook-js-preview#displayreplyallform-formdata--options--callback-) | [Preview](outlook-requirement-set-preview.md) |
...
| displayReplyFormAsync(formData, [options], [callback]) | ReadItem | [Appointment Attendee](/javascript/api/outlook/office.appointmentread?view=outlook-js-preview#displayreplyform-formdata-options--callback-) | [Preview](outlook-requirement-set-preview.md) |
| | | [Message Read](/javascript/api/outlook/office.messageread?view=outlook-js-preview#displayreplyform-formdata--options--callback-) | [Preview](outlook-requirement-set-preview.md) |
