...
#### Office.context.mailbox.item.getInitializationContextAsync (available modes: [Appointment Attendee](/javascript/api/outlook/office.appointmentread), [Message Read](/javascript/api/outlook/office.messageread))
