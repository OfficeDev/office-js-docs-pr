...
Gets an object that provides methods to get or update the Bcc (blind carbon copy) line of a message. The collection is limited to a maximum of 100 members. Compose mode only.
