...
|**Office hosts**|**Methods in set**|
|:-----|:-----|
| See [Shared runtime requirement sets](shared-runtime-requirement-sets.md). | Office.addin.setStartupBehavior<br>Office.addin.hide<br>Office.addin.onVisibilityModeChanged<br>Office.addin.setStartupBehavior<br>Office.addin.showAsTaskpane<br> |
