...
|:-----|:-----|:-----|
| ActiveView | PowerPoint for iPad<br>PowerPoint for Mac|Document.getActiveViewAsync|
| AddInCommands | See [Add-in command requirement sets](add-in-commands-requirement-sets.md). | |
| BindingEvents  | Access Web Apps<br>Excel<br>Excel for iPad<br>Excel for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Binding.addHanderAsync<br>Binding.removeHanderAsync|
| CompressedFile    | Excel<br>Excel for iPad<br>Excel for Mac<br>PowerPoint for iPad<br>PowerPoint for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Supports output to Office Open XML (OOXML) format as a byte array<br>(Office.FileType.Compressed) when using the Document.getFileAsync method.|
...
| DocumentEvents    | Excel<br>Excel for iPad<br>Excel for Mac<br>OneNote Online<br>PowerPoint for iPad<br>PowerPoint for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Document.addHandlerAsync<br>Document.removeHandlerAsync|
| File  | Excel<br>Excel for iPad<br>Excel for Mac<br>PowerPoint for iPad<br>PowerPoint for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Document.getFileAsync<br>File.closeAsync<br>File.getSliceAsync|
...
| PdfFile   | Excel for Mac<br>PowerPoint for iPad<br>PowerPoint for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Supports output to PDF format (Office.FileType.Pdf)<br>when using the Document.getFileAsync method.|
| Selection | Excel<br>Excel for iPad<br>Excel for Mac<br>PowerPoint for iPad<br>PowerPoint for Mac<br>Project<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Document.getSelectedDataAsync<br>Document.setSelectedDataAsync|
| Settings  | Access Web Apps<br>Excel<br>Excel for iPad<br>Excel for Mac<br>OneNote Online<br>PowerPoint for iPad<br>PowerPoint for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Settings.get<br>Settings.remove<br>Settings.saveAsync<br>Settings.set|
| TableBindings | Access Web Apps<br>Excel<br>Excel for iPad<br>Excel for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Bindings.addFromNamedItemAsync<br>Bindings.addFromSelectionAsync<br>Bindings.getAllAsync<br>Bindings.getByIdAsync<br>Bindings.releaseByIdAsyncTable<br>Binding.addColumnsAsyncTable<br>Binding.addRowsAsyncTable<br>Binding.deleteAllDataValuesAsyncTable<br>Binding.getDataAsyncTable<br>Binding.setDataAsync|
| TableCoercion | Access Web Apps<br>Excel<br>Excel for iPad<br>Excel for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Supports coercion to the "table" data structure (Office.CoercionType.Table) when reading and writing data using the Document.getSelectedDataAsync, Document.setSelectedDataAsync, Binding.getDataAsync, or Binding.setDataAsync methods.|
| TextBindings  | Excel<br>Excel for iPad<br>Excel for Mac<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Bindings.addFromNamedItemAsync<br>Bindings.addFromSelectionAsync<br>Bindings.getAllAsync<br>Bindings.getByIdAsync<br>Bindings.releaseByIdAsyncText<br>Binding.getDataAsyncText<br>Binding.setDataAsync|
| TextCoercion  | Excel<br>Excel for iPad<br>OneNote Online<br>PowerPoint for iPad<br>PowerPoint for Mac<br>Project<br>Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Supports coercion to text format (Office.CoercionType.Text) when reading and writing data using the Document.getSelectedDataAsync, Document.setSelectedDataAsync, Binding.getDataAsync, or Binding.setDataAsync methods.|
| TextFile  | Word 2013 and later<br>Word 2016 for Mac and later<br>Word web versions<br>Word for iPad|Supports output to text format (Office.FileType.Text) when using the Document.getFileAsync method.|
...
|:-----|:-----|
|Bindings.addFromPromptAsync|Access web apps, Excel, Excel for iPad, and Excel for Mac|
|Document.getFilePropertiesAsync|Excel, Excel for iPad, Excel for Mac, PowerPoint, PowerPoint for iPad, PowerPoint for Mac, Word, Word for iPad, and Word for Mac|
...
|Document.goToByIdAsync|Excel, Excel for iPad, Excel for Mac, PowerPoint, PowerPoint for iPad, PowerPoint for Mac, Word, Word for iPad, and Word for Mac|
|Settings.addHandlerAsync|Access web apps and Excel web versions|
|Settings.refreshAsync|Access web apps, Excel, PowerPoint, Word|
|Settings.removeHandlerAsync|Access web apps and Excel web versions|
|TableBinding.clearFormatsAsync|Excel, Excel for iPad, and Excel for Mac|
|TableBinding.setFormatsAsync|Excel, Excel for iPad, and Excel for Mac|
|TableBinding.setTableOptionsAsync|Excel, Excel for iPad, and Excel for Mac|
