...
>
> <sup>3</sup> Support for new Outlook on Mac is available from version 16.38.506. For more information, see the [new Outlook on Mac](../../outlook/compare-outlook-add-in-support-in-outlook-for-mac.md#new-outlook-on-mac) section.
>
