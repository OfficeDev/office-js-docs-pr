...
>
> <sup>4</sup> Preview support for the new Outlook on Mac is available from version 16.38.506. For more information, see the [Add-in support in new Outlook UI on Mac](../../outlook/compare-outlook-add-in-support-in-outlook-for-mac.md#add-in-support-in-new-outlook-ui-on-mac-preview) section.
>
