...
You don't need to actually produce an add-in with this UI to experiment with the code. You can use the [Script Lab tool](../overview/explore-with-script-lab) to prototype the important code. Use the following assignment statement to create the mapping array.
