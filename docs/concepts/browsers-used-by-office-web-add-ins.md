...
|Windows 8.1, 10 | Office 365 ver. >= 16.0.12822 |Microsoft Edge with WebView2 &mdash; Chromium based Edge web control &mdash; if it is installed<br>If it is not, Microsoft Edge with original Webview, also called EdgeHTML
