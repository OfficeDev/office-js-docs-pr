...
You can write your code in either TypeScript or in a version of JavaScript later than ES5 and then transpile it at build-time into ES5 JavaScript. The resulting ES5 files are what you upload to your add-in's web application.
