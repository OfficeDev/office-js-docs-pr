...
> [!NOTE]
> Starting with the release of the Excel 2013 SP1 and the corresponding build of Excel, you can now [set formatting when writing and updating data in bound tables](../excel/excel-add-ins-tables.md).
