...
### How it works at Configure your Office Add-in to use a shared runtime
...
1. The client-side code of the add-in calls the Office.js API [getAccessToken](/javascript/api/office-Configure your Office Add-in to use a shared runtime/officeConfigure your Office Add-in to use a shared runtime.auth#office-Configure your Office Add-in to use a shared runtime-officeConfigure your Office Add-in to use a shared runtime-auth-getaccesstoken-member(1)). This tells the Office host to obtain an access token for the add-in.
