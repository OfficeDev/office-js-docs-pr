...
>**Note:** This feature is currently in preview and is subject to change in future releases. For this preview, single sign-on is supported only for work or school (Office 365) accounts and only for desktop versions of Office. Also, for Outlook, SSO only works if the Outlook account matches the Office user account as seen in **File** | **Office account**.
...
For Office hosts, other than Outlook, the markup should be added to the very end of the `<VersionOverrides ... xsi:type="VersionOverridesV1_0">` section. In Outlook, the markup should be added to the very end of the `<VersionOverrides ... xsi:type="VersionOverridesV1_1">` section.
