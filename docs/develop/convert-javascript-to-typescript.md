...
2. From the **Tools** tab, choose **NuGet Package Manager** and then select **Manage NuGet Packages for Solution...**.

3. With the **Browse** tab selected, enter **office-js.TypeScript.DefinitelyTyped** into the search box. Install or update this package if it is already installed. This will add the TypeScript type definitions for the Office.js library to your project.

4. In the same search box, enter **jquery.TypeScript.DefinitelyTyped**. Install or update this package if it is already installed. This will add the jQuery TypeScript definitions into your project. The packages for both jQuery and Office-js will now appear in a new file generated by Visual Studio, called **packages.config**.
