...
|12009|The user chose to ignore the dialog box. This error can occur in Office for the web, where users may choose not to allow an add-in to present a dialog box. For more information, see [Handling pop-up blockers with Office for the web](dialog-best-practices.md#handling-pop-up-blockers-with-office-for-the-web).|
