...
If your add-in uses client-side routing, as single-page applications (SPA) typically do, you have the option to pass the URL of a route to the [displayDialogAsync](/javascript/api/office/office.ui) method, instead of the URL of a complete and separate HTML page. *We recommend that you not do this.*
