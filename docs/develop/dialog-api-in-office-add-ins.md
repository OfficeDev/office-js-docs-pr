...
|12009|The user chose to ignore the dialog box. This can occur in the online versions of Office where users are given the option to not allow an Add-in to present a dialog.|
