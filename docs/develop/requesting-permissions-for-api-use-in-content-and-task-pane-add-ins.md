...
|:-----|:-----|
|**Restricted**|The methods of the [Settings](../../reference/shared/document.settings.md) object, and the [Document.getActiveViewAsync](../../reference/shared/document.getactiveviewasync.md) method.This is the minimum permission level that can be requested by a content or task pane add-in.|
