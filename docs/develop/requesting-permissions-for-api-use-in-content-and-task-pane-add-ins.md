...
|:-----|:-----|
|**Restricted**|The methods of the [Settings](https://dev.office.com/reference/add-ins/shared/settings) object, and the [Document.getActiveViewAsync](/reference/shared/document.getactiveviewasync.md) method.This is the minimum permission level that can be requested by a content or task pane add-in.|
