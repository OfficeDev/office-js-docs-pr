...
In an Angular app, the UI sometimes won't update. This is because that part of code runs out of Angular zone. The solution is putting that part of code in the zone. The following codes shows the way:
