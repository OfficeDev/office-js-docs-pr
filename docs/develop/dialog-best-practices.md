...
- A host window, which can be a task pane or the UI-less [function file](/javascript/api/manifest/functionfile.md) of an add-in command, can have only one dialog box open at a time.
