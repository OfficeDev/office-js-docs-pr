...
1. Clone or download the repo at [Office Add-in NodeJS SSO](https://github.com/officedev/office-add-in-nodejs-sso). 
    ...
    > * The **Completed Multitenant** version of the sample is same as **Completed**, except that the latter does not support multitenancy. If you are intended to support all microsoft accounts from different domains to use sso (onmicrosoft.com, outlook.com etc.), try this one.
