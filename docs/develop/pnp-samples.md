...
| Name                | Description         |
|:--------------------|:--------------------|
| [Open in Excel](/excel/pnp-open-in-excel.md) | Extend your SaaS web application so that your customers can open their data from a web page directly to Microsoft Excel. |
