...
> - Projects created in Visual Studio, as distinct from Visual Studio Code, cannot be converted at this time.
...
1. In the **Application name** dialog, give a name to the project (with no spaces). Teams Toolkit will create the project with your source files and scaffolding. It will then open the project *in a second Visual Studio Code window*. Close the original Visual Studio Code window.
...
1. You can now work with your add-in. Be sure you are working in the **Inbox** of *your Microsoft 365 account identity*.
...
1. Run the command `npm run start:desktop`. The project builds and a Node dev-server window opens. This process may take a couple of minutes. Eventually, Outlook desktop will open.
...
### NodeJS and npm projects that are not created with Yeoman Generator

If you don't want to use the Teams Toolkit and your project was not created with the Office Yeoman generator, take these steps.
