...
- The first 30 characters of `<DisplayName>` becomes the value of [`"name.short"`](/microsoft-365/extensibility/schema/root-name?view=m365-app-prev&tabs=syntax#short) in the unified manifest.
- The first 100 characters of `<DisplayName>` becomes the value of [`"name.full"`](/microsoft-365/extensibility/schema/root-name?view=m365-app-prev&tabs=syntax#full) in the unified manifest.
- The first 250 characters of `<Description>` becomes the value of [`"description.short"`](/microsoft-365/extensibility/schema/root-description?view=m365-app-prev&tabs=syntax#short) in the unified manifest.
- The first 4000 characters of `<Description>` becomes the value of [`"description.full"`](/microsoft-365/extensibility/schema/root-description?view=m365-app-prev&tabs=syntax#full) in the unified manifest.
- The first 32 characters of the `<ProviderName>` becomes the value [`"developer.name"`](/microsoft-365/extensibility/schema/root-developer?view=m365-app-prev&tabs=syntax#name) in the unified manifest.
