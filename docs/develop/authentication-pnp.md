...
The following articles and samples are provided to help with authentication scenarios.

## Articles

- [Authorize to Microsoft Graph without SSO](authorize-to-microsoft-graph-without-sso.md)
