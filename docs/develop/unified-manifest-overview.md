...
| "autoRunEvents" | Configures an event handler for a specified event. To learn about event-based activation, see [Configure your Outlook add-in for event-based activation](../outlook/autolaunch.md). |
      ...
      "runtimes": [
        {
          ...
          "actions": [
            ...
            {
              "id": "onMessageReadWithCustomHeader",
              "type": "executeFunction"
            },
            {
              "id": "onMessageReadWithCustomAttachment",
              "type": "executeFunction"
            }
          ]
        },
      ...
      "autoRunEvents": [
        {
          ...
          "events": [
            ...
            {
              "type": "onMessageReadWithCustomHeader",
              "actionId": "onMessageReadWithCustomHeader",
              "options": {
                "customHeaderName": "contoso-spam-simulation"
              }
            },
            {
              "type":"onMessageReadWithCustomAttachment",
              "actionId": "onMessageReadWithCustomAttachment",
              "options": {
                "messageAttachmentExtensionType": [
                  "pdf",
                  "txt"
                ]
              }
