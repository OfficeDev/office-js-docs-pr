...
description: 'Learn how to use PowerPoint add-ins to build engaging solutions for your users' presentations across platforms including Windows, iPad, Mac, and in a browser'
ms.date: 11/07/2019
ms.topic: conceptual
