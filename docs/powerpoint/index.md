            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="../reference/overview/powerpoint-add-ins-reference-overview.md">Learn how to use the Office JavaScript API to interact with document content and metadata in PowerPoint.</a></p>
                    </div>
                </div>
            </div>
        </div>
