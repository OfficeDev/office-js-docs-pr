...
1. Select and hold (or right-click) the solution in **Solution Explorer** and choose **Add > New Project**.
...
1. In **Solution Explorer**, select and hold (or right-click) the **Cell-Analyzer** project, and choose **Add Reference**.
1. Select **CellAnalyzerSharedLibrary**, and choose **OK**.
1. In **Solution Explorer**, expand the **Cell-Analyzer** project, select and hold (or right-click) the **CellAnalyzerPane.cs** file, and choose **View Code**.
...
1. In **Solution Explorer**, select and hold (or right-click) the **Cell-Analyzer** project, and choose **Add > New Project**.
...
1. Select and hold (or right-click) **Dependencies**, and choose **Add Reference**.
1. Select **CellAnalyzerSharedLibrary**, and choose **OK**.
1. Select and hold (or right-click) the **Controllers** folder, and choose **Add > Controller**.
...
1. Select and hold (or right-click) the **CellAnalyzerRESTAPI** project, and choose **Set as Startup Project**.
1. On the **Debug** menu, choose **Start Debugging**.
...
1. In **Solution Explorer**, select and hold (or right-click) the **Cell-Analyzer** solution, and choose **Add > New Project**.
...
1. In **Solution Explorer**, select and hold (or right-click) the top node **Solution 'Cell-Analyzer'**, and choose **Set Startup Projects**.
...
1. In **Solution Explorer**, select and hold (or right-click) the **CellAnalyzerRESTAPI** project, and choose **Publish**.
