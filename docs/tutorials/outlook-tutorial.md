...
Save all of your changes and run `npm run start:server` from the command prompt, if the server isn't already running. Then complete the following steps to test the **Insert default gist** button.
...
Save all of your changes and run `npm run start:server` from the command prompt, if the server isn't already running. Then complete the following steps to test the **Insert gist** button.
