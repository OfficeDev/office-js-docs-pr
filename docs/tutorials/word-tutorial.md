...
description: 'In this tutorial, you will build a Word add-in that inserts (and replaces) text ranges, paragraphs, images, HTML, tables, and content controls. You will also learn how to format text and how to insert (and replace) content in content controls.'
ms.date: 01/16/2020
ms.prod: word
