...
1. Start the local web server and sideload your add-in.
    ...
    Run the following command in the root directory of your project. When you run this command, the local web server will start (if it's not already running). Replace "{url}" with the URL of a OneNote document on your OneDrive or a SharePoint library to which you have permissions.
