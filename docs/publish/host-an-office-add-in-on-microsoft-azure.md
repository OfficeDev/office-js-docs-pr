...
2. Select and hold (or right-click) the C:\ drive and then choose **New** > **Folder**.

3. Name the new folder AddinManifests.

4. Select and hold (or right-click) the AddinManifests folder and then choose **Share with** > **Specific people**.
...
2. Select and hold (or right-click) the web project and then choose **Publish**. The web project contains Office Add-in web app files so this is the project that you publish to Azure.
...
2. Expand the Office Add-in project (for example WordWebAddIn), select and hold (or right-click) the manifest folder, and then choose **Open**. The add-in XML manifest file opens.
